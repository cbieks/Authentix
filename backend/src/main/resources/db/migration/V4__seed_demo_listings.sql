-- Demo listings (seller_id = 2). Same data as resources/seed-listings.sql.
...
(@seller_id, 25, 'PSA 10 1st Edition Charizard - Base Set', 'PSA 10 Gem Mint 1st Edition Charizard from Base Set. Highly sought-after blue chip Pokémon investment card with pristine centering and flawless case.', 600.00, 'Graded', 'SHIP', '90007', 'Los Angeles', 'California', 'ACTIVE', @now, @now),
(@seller_id, 8, 'CGC 9.8 Amazing Fantasy #15 (Reprint)', 'CGC 9.8 graded Amazing Fantasy #15 reprint edition. Professionally slabbed and authenticated. Perfect for Marvel collectors.', 320.00, 'Graded', 'SHIP', '97225', 'Portland', 'Oregon', 'ACTIVE', @now, @now),
(@seller_id, 25, '1999 Pokémon Base Set Booster Box (Sealed)', 'Factory sealed 1999 Pokémon Base Set Booster Box. Unweighed and stored in climate-controlled environment since purchase.', 1400.00, 'Sealed', 'SHIP', '97225', 'Portland', 'Oregon', 'ACTIVE', @now, @now),
(@seller_id, 1, 'LEGO Star Wars Captain Rex (75157)', 'LEGO Star Wars Captain Rex (75157) complete with original box and instructions. Rare retired set in excellent condition.', 850.00, 'Excellent', 'SHIP', '97225', 'Portland', 'Oregon', 'ACTIVE', @now, @now),
(@seller_id, 28, 'Rolex Submariner Date 16610', 'Rolex Submariner Date 16610. Includes original box and papers. Recently serviced and authenticated by certified watchmaker.', 10000.00, 'Very Good', 'SHIP', '97225', 'Portland', 'Oregon', 'ACTIVE', @now, @now),
